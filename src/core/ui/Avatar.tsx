...
import * as JazziconModule from 'react-jazzicon'

// react-jazzicon is CJS — Vite 8 may double-wrap the default export.
const resolved = JazziconModule.default ?? JazziconModule
const Jazzicon = (
  typeof resolved === 'function' ? resolved : (resolved as { default: unknown }).default
) as FC<{ diameter: number; seed: number }>
const jsNumberForAddress = (JazziconModule as unknown as Record<string, unknown>)
  .jsNumberForAddress as (address: string) => number
