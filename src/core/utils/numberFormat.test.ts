...
import { formatNumber, formatUSDPrice, NumberType } from '@/src/core/utils/numberFormat'
...
it('formats fiat estimates for tokens correctly', () => {
  ...
  expect(formatNumber(10000000000000000000000000000000, NumberType.FiatTokenPrice)).toBe(
    '$1.000000E31',
  )
})
