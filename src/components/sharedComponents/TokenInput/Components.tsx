...
export const Textfield = styled(BaseTextfield).attrs({
  ...
  && {
    ...
    height: auto;
    min-width: 0;
    padding: var(--base-token-input-texfield-padding, var(--base-common-padding, 8px));

    ${breakpointMediaQuery(
      'tabletPortraitStart',
      css`
        font-size: 3.2rem;
        padding: var(--base-token-input-texfield-padding, 0 var(--base-common-padding-xl, 16px));
      `,
    )}
  }
`
...
const ButtonCSS = css`
  ...
  height: auto;
  min-width: 100px;
  padding: var(--base-token-input-dropdown-button-padding, 0 var(--base-common-padding, 8px));
