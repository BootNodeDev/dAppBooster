 ...
 * @param {number | 'disabled'} [truncatedHashLength] - The number of characters to show at the start and end of the hash. 'disabled' if you don't want to truncate the hash value. Default is 6.
 */
