...
const Examples: FC<HTMLAttributes<HTMLElement>> = ({ ...restProps }) => {
  ...
  const items: ItemProps[] = [
    ...
    },
    {
      ...
      href: 'https://bootnodedev.github.io/dAppBooster/modules/sharedComponents_TokenDropdown.html',
      icon: <ImgTokenList />,
    ...
    },
    {
      ...
      href: 'https://bootnodedev.github.io/dAppBooster/modules/sharedComponents_Hash.html',
      icon: <ImgHash />,
