...
Now, you can open http://localhost:5173/weth on your dev environment to see it working.
...
Add the new token list to `src/constants/tokenLists.ts` like so:
...
We will use the [TokenInput](https://github.com/BootNodeDev/dAppBooster/blob/develop/src/components/sharedComponents/TokenInput/index.tsx) component. This component will give us the following features:
