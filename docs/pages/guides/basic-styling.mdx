...
:::info
**Tip:** you can try using https://github.com/BootNodeDev/dAppBoosterBasicStyling for this guide.
:::
...
- **Styled Components:** Is used to style components, so each component has its own styles following the CSS-in-JSS pattern and philosophy.
