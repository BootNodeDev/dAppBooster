...
:::info
**Tip:** a complete demo of the results of this guide can be found in the https://github.com/BootNodeDev/dAppBoosterBasicStyling fork of the dAppBooster repository.
:::
