...
We use [Styled Components](https://styled-components.com/) for styling. Basic CSS and CSS-in-JSS knowledge will be beneficial to understand this guide, but you can also learn as you go. There's nothing too complicated about this.
