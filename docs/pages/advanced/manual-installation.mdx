...
This means that you **have add a subgraph [API key](https://thegraph.com/studio/apikeys/)**, provide all the subgraph-related env vars (you can use the defaults in `.env.example`, and then run the code generator or otherwise the app will not run.
