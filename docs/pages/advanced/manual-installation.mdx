...
The default branch is `develop`, which is fine if you're developing new features of fixing bugsf or dAppBooster, but if you're developing a new product you probably want to checkout the production-ready `main` branch:
