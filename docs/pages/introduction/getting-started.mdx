...
Get a clean instance of the starter-kit by running this command. Just accept all the default options.
...
Now, you can move to the project and edit your `.env.local` file by setting your wallet connect project id.
